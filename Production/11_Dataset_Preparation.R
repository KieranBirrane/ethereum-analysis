...
SELECT 
  ...
  ,COUNT(CASE [Transaction_Type] WHEN 'REG' THEN [Data_Amount] ELSE NULL END)   AS [Count_REG]
  ,SUM(CASE [Transaction_Type] WHEN 'REG' THEN [Data_Amount] ELSE NULL END)     AS [Sum_REG]
  ,AVG(CASE [Transaction_Type] WHEN 'REG' THEN [Data_Amount] ELSE NULL END)     AS [Average_REG]
  ,STDEV(CASE [Transaction_Type] WHEN 'REG' THEN [Data_Amount] ELSE NULL END)   AS [Std_Dev_Pop_REG]
