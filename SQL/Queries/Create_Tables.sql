...
ON input.Ethereum_Blocks([data#number]);



IF OBJECT_ID('input.Addresses', 'U') IS NOT NULL DROP TABLE input.Addresses
GO
CREATE TABLE input.Addresses(
	[data#coinbase]		VARCHAR(42)		NULL
